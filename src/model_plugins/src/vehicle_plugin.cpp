...
void ModelHandler::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf){
	...
	this->vehicle = std::make_unique<Vehicle>(boost::dynamic_pointer_cast<physics::Actor>(_parent), 1, 10, 2, ignition::math::Pose3d(0,0,1,0,0,0), ignition::math::Vector3d(0,0,0), animation);
